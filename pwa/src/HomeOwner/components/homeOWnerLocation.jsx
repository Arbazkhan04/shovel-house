...
export default function HomeOwnerLocation({nextStep}) {
  const { jobPostProgress, addService, removeService } = useJobPostProgressContext();
  
  const handleAddService = (service) => {
    if (jobPostProgress.selectedServices.includes(service)) {
      ...
      <div className="flex flex-col self-center mt-6 w-full max-w-[350px]">
        ...
        <div className="flex flex-col mt-5 w-full text-black">
          ...
          <div className="flex gap-3 items-center mt-3 w-full text-sm tracking-tight leading-loose text-center">
            {/* Service 1 */}
            <div
              className={`flex flex-col justify-center items-center p-3 rounded w-[139px] h-[150px] ${jobPostProgress.selectedServices.includes('Snow Shoveling') ? 'bg-gray-300' : 'bg-zinc-100'}`}
            ...
            >
              ...
              <div className="mt-2 relative">
                Snow Shoveling
                {jobPostProgress.selectedServices.includes('Snow Shoveling') && (
            ...
            {/* Service 2 */}
            <div
              className={`flex flex-col justify-center items-center p-3 rounded w-[139px] h-[150px] ${jobPostProgress.selectedServices.includes('Lawn Mowing') ? 'bg-gray-300' : 'bg-zinc-100'}`}
            ...
            >
              ...
              <div className="mt-2 relative">
                Lawn Mowing
                {jobPostProgress.selectedServices.includes('Lawn Mowing') && (
            ...
            {/* Service 3 */}
            <div
              className={`flex flex-col justify-center items-center p-3 rounded w-[139px] h-[150px] ${jobPostProgress.selectedServices.includes('Another Service') ? 'bg-gray-300' : 'bg-zinc-100'}`}
            ...
            >
              ...
              <div className="mt-2 relative">
                Another Service
                {jobPostProgress.selectedServices.includes('Another Service') && (
                  <div className="absolute -top-12 right-0 w-4 h-4 rounded-full">
                    <span className="text-white text-xs">✔</span>
                  </div>
                )}
