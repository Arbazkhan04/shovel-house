...
export default function ShovellerDetails({ nextStep }) {
    ...
    // Handle neighborhood input change and clear lat/lng if the input is empty
    const handleNeighborhoodChange = (e) => {
        const value = e.target.value;
        setFormData((prevData) => ({
            ...prevData,
            // Reset latitude and longitude when input is cleared
            latitude: value === "" ? null : prevData.latitude,
            longitude: value === "" ? null : prevData.longitude,
        }));

        // If the input is cleared, set an error
        if (value === "") {
            setErrors((prevErrors) => ({
                ...prevErrors,
    ...
    // Handle the next step with validation
    const handleNext = () => {
        const newErrors = {};
